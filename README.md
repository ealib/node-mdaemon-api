...
8. run `npm install node-mdaemon-api`
   ...
   npm WARN node-mdaemon-api@21.5.2-alpha.8 requires a peer of mdaemon@21.x but none is installed. You must install peer dependencies yourself.
   npm WARN test-md-node@1.0.0 No description
   npm WARN test-md-node@1.0.0 No repository field.

   + node-mdaemon-api@21.5.2-alpha.8
...
node-mdaemon-api 21.5.2-alpha.8 license
